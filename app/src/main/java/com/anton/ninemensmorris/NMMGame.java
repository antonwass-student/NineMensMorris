...
public class NMMGame {
    ...
    public NMMGame(GameMode mode, Map map)
    {
        this.map = map;
        this.gameMode = mode;
        init();
    ...
    public void setNeighbors(){
        ...
        }else if(map.equals(Map.BIG)){
            gameboard[0].setNeighbors(null, gameboard[8], gameboard[7], null, 0, 0);
            gameboard[1].setNeighbors(null, null, gameboard[9], null, 3, 0);
            gameboard[2].setNeighbors(null, null, gameboard[3], gameboard[10], 6, 0);
            gameboard[3].setNeighbors(gameboard[2], null, gameboard[4], gameboard[11], 6, 3);
            gameboard[4].setNeighbors(gameboard[3], null, null, gameboard[12], 6, 6);
            gameboard[5].setNeighbors(gameboard[13], null, null, null, 3, 6);
            gameboard[6].setNeighbors(gameboard[7], gameboard[14], null, null, 0, 6);
            gameboard[7].setNeighbors(gameboard[0], gameboard[15], gameboard[6], null, 0, 3);
            gameboard[8].setNeighbors(null, gameboard[16], gameboard[15], gameboard[0], 1, 1);
            gameboard[9].setNeighbors(gameboard[1], null, gameboard[17], null, 3, 1);
            gameboard[10].setNeighbors(null, gameboard[2], gameboard[11], gameboard[18], 5, 1);
            gameboard[11].setNeighbors(gameboard[10], gameboard[3], gameboard[12], gameboard[19], 5, 3);
            gameboard[12].setNeighbors(gameboard[11], gameboard[4], null, gameboard[20], 5, 5);
            gameboard[13].setNeighbors(gameboard[21], null, gameboard[5], null, 3, 5);
            gameboard[14].setNeighbors(gameboard[15], gameboard[22], null, gameboard[6], 1, 5);
            gameboard[15].setNeighbors(gameboard[8], gameboard[23], gameboard[14], gameboard[7], 1, 3);
            gameboard[16].setNeighbors(null, gameboard[17], gameboard[23], gameboard[8], 2, 2);
            gameboard[17].setNeighbors(gameboard[9], gameboard[18], null, gameboard[16], 3, 2);
            gameboard[18].setNeighbors(null, gameboard[10], gameboard[19], gameboard[17], 4, 2);
            gameboard[19].setNeighbors(gameboard[18], gameboard[11], gameboard[20], null, 4, 3);
            gameboard[20].setNeighbors(gameboard[19], gameboard[12], null, gameboard[21], 4, 4);
            gameboard[21].setNeighbors(null, gameboard[20], gameboard[13], gameboard[22], 3, 4);
            gameboard[22].setNeighbors(gameboard[23], gameboard[21], null, gameboard[14], 2, 4);
            gameboard[23].setNeighbors(gameboard[16], null, gameboard[22], gameboard[15], 2, 3);
        }
    }
